...
kr1 = WIB.LINE()
kr1.login(token="EpWtfjhEG8pvYMV8wVw4.Espwl7CcKKW9erpIgvmoTa.fUAWoL9fHu/p3qGzdgbz5KvdfrNllp4ediJWBW7r46k=")#1 => akun utama
kr1.loginResult()

kr2 = WIB.LINE()
kr2.login(token="Epqa057bhnAnfSLMPZDa.m05PgfJ20OHCnyQJ8clMQG.Q/KBLMB6WF4BJQYqNtnnlSfqZvyWMOwzG9RyxOv3b1I=")#2 => asist
kr2.loginResult()

kr3 = WIB.LINE()
kr3.login(token="EpdECYN0QJfknD0BfCz3.eFqKRkdx3UCPENti1CVbCW.jH7C3Vss4HBnx2oeR3JYItolRX2IHkUN8PghpC5GsBA=")#3 => asist
kr3.loginResult()
...
#==========================[WIB]===========================
                    ...
                    if wait["lang"] == "JP":
                        ...
                        kr1.sendText(msg.to,keymsg)
#==========================[WIB]===========================
            elif msg.text in ["keypro","helppro"]:
                #if msg.from_ in admin:
                    if wait["lang"] == "JP":
                        ...
                        kr1.sendText(msg.to,helppro)
#==========================[WIB]===========================
            elif msg.text in ["keyself","Help1"]:
                #if msg.from_ in admin:
                    if wait["lang"] == "JP":
                        ...
                        kr1.sendText(msg.to,helpself)
#==========================[WIB]===========================
            elif msg.text in ["keygrup","Help2"]:
                #if msg.from_ in admin:
                    if wait["lang"] == "JP":
...
#==========================[WIB]===========================
                    ...
                    if wait["lang"] == "JP":
                        ...
                        kr1.sendText(msg.to,helpset)
#==========================[WIB]===========================
            elif msg.text in ["keymedia","Help4"]:
                #if msg.from_ in admin:
                    if wait["lang"] == "JP":
...
#==========================[WIB]===========================
                ...
                #if msg.from_ in admin:
                    start = time.time()
                    kr1.sendText(msg.to,"【  τєѕ ѕρєє∂ 】\n🔹️ Type: speed\n🔹️ ૮αℓ૮µℓαƭเɳɠ.............")
                    elapsed_time = time.time() - start
                    kr1.sendText(msg.to,"【ϐοτ ѕρєє∂】\n🔹️ Tipe: Check speed\n🔹️ Time: 0.04 - 0.06 \n🔹️ Speed :%sseconds" % (elapsed_time))
#==========================[WIB]===========================
...
#==========================[WIB]===========================
                ...
                kr2.sendText(msg.to,jawaban)
#==========================[WIB]=========================== 
            elif msg.text in ["Rules","rules"]:
                kr2.sendText(msg.to,"Wellcome To Universal Knowlege")
                kr2.sendText(msg.to,"Rules Grup")
                kr2.sendText(msg.to,"1. Melakukan debat dengan tertib dan menggunakan bahasa yg mudah di mengerti dan sopan\n\n2. Dilarang menjelekkan menajatuhkan berkaitan SARA (Suku, ras, agama) antar golongan\n\n3.pembersihan bisa dilakukan kapan saja jika tidak aktif di dalam grup pembahasan\n\n4. jangan mengisi note untuk hal yang tidak ada hubungannya dengan tujuan grup\n\n5. dilarang mengirim konten oa yang tidak hubungannya dengan tujuan grup\n\n6.minimalisir OOT di grup Utama\n\n7. Jangan Memainkan Bot di grup utama. (untuk di grup OOT diperbolehkan memainkan bot,asal member lain tidak terganggu)\n\n8. Wajib aktif ikut bahasan di grup utama\n\n9. Wajib mengisi note yg berkaitan dgn pengetahuan di grup utama\n\n10. Minimalisirkan menshare gore dalam bentuk video maupun foto\n\n11. Like atau comment post UK (tidak ada paksaan)")
                kr2.sendText(msg.to,"Manusia yang cerdas tau dimana dia berpijak dan mengikuti peraturan yang ada")
#==========================[WIB]===========================
